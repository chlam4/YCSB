...
public class TimeSeriesWorkload extends Workload {
    ...
    private static final AtomicInteger currFieldIndex = new AtomicInteger();
    ...
    public boolean doInsert(DB db, Object threadstate) {
        final String field = fieldPrefix + currFieldIndex.getAndIncrement()%fieldCount;
    ...
    public boolean doTransaction(DB db, Object threadstate) {
        ...
        final String field = fieldPrefix + rand.nextInt(fieldCount);
